<?php
    session_start();
    define('pg','http://localhost/YOUTUBE/Loja_GIT/Loja');
   ...
   <!--CONTAINER 
	...
	<h1>Produtos em destaque</h1></br>
        ...
        <div class="row featurette">
          <div class="col-md-7">
            <h2 class="featurette-heading">FINH Plante artificielle en pot 27cm<span class="text-muted">Supreendente, não?!</span></h2>
            <p class="lead">La plante artificielle en pot Finh, présentant un joli mélange de plantes grasses, ajoute une touche fraîche et colorée dans tout espace contemporain.
              </p>
          </div>
          <div class="col-md-5">
