        	...
        	<div class="pb-3">
        		<div>
        			<div class="row">
        				...
        				<div class="col-12">
        					<div class="form-group">
        						<label><input type="checkbox" name="hidden"<?= $rowFourDesc['hidden'] == '1' ? ' checked' : ''?> value="1"> Masquer ce fournisseur de la liste.</label>
        						<div><small>Cette option ne rend PAS ce fournisseur inactif. Il fait simplement le masquer de la liste des fournisseurs dans la page Fournisseurs.</small></div>
        					</div>
        				</div>
        				<div class="col-12">
        					<div class="form-group">
