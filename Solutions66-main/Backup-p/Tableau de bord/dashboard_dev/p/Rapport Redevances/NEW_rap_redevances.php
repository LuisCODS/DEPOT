<?php
//Stock le FROM  et le TO des dates
$listVALUE = [];
$listAND1 = [];
$listTotal1 =0;
$listAND2 = [];
											...
											<table class="card-view-no-edit page-size-table table-hover-new table  table-striped table-no-bordered table-condensed">
												<thead>
													<tr>
														...
														<th style='text-align:right'><?= L('total Zerabella',"o")?></th>
												...
												<tbody>
													<?php 
													$tot8 = $tot7 = $tot6 = $tot5 = $tot4 = $tot3 = $tot2 = $tot1 = $tot0 = 0;
													...
													while ($rowmagasin = $resulmagasin->fetch_assoc()){
														...
														// ============================= Fondation Zara Bella	 ============================= 
														$queryRaport0 = "SELECT SUM(facture_item.montant) `totalZerabella`
																			...
																			WHERE facture_item.id_departement = 906
																			AND $listTotal1";
														$resulRaport0 =query($queryRaport0,$listVALUE,$dbAnimoCaisse);
														$rowRaport0 = $resulRaport0->fetch_assoc();
														...
														<tr>
													    	...
													    	<!-- Sans redevance	-->
															<td style='text-align:right'><?php echo formatPrix($rowRaport0['totalZerabella']);?> </td>
													    	<?php  $tot0 += $rowRaport0['totalZerabella']?>  
															<!-- Redevances-->
											        	...
											        	<?php }?>                                         
														 <tr>
															...
															<td style='text-align:right'><h4><?= formatPrix($tot0);?></h4></td>
