<?php
    if (!has_rights("publicite_add") ){ require(__DIR__."/403.php");return; }
    ...
    /*Recupere les fichiers associés à la table PUBLICITE */
	if($rowPublicite){
                            		...
                            		<div class="col-md-12">
                            		    <? /*Input hidden to get  publicite  id  */?>
                            			 <form role="form" method="POST" enctype="multipart/form-data" action="?p=publicite" id="form_delpublicite">
                            				<input name="id_pub" type="hidden" value="<?php echo $rowPub['id_pub'];?>" />
                            				<input name="delete" type="hidden" value="publicite" />
                            			 </form>
                            			 <form role="form" method="POST" enctype="multipart/form-data" action="?p=publicite" id="">
                            				<?php 
                            				/* =======  Select fournisseurs  ======= */
                            					...
                            					<div class="col-md-12">
                            						...
                            						<div class="form-group">
                            							<select class="ui search fluid simple-select select-dropdown ligneFourI1" name="id_fournisseur">
                            								...
                            								<option value="999" <?php echo ($rowPub["id_fournisseur"]==999 ? " selected" : "")?>>Animo Etc (promotion maison)</option>
                            								<?php while ( $row_fournisseur = $resultFour->fetch_assoc()){?>
                            									<option value="<?php echo $row_fournisseur["id_fournisseur"] ?>" <?php echo ($rowPub["id_fournisseur"]==$row_fournisseur["id_fournisseur"])?"selected":"" ?> ><?php echo $row_fournisseur["nom"] ?></option>
                            								<?php }?>
                            							</select>
                            						</div>
                            					</div>				
                            				...
                            				<div class="row">
                            					<div class="col-md-12">
                            						...
                            						<div class="form-group">
                            							<input name="pub_name" class="form-control" type="text" value="<?= $rowPub["pub_name"]?>" />
                            						</div>
                            					</div>				
                            				</div>
                            				<?/* =======  textarea ======= */?>
                            				<div class="row">	
                            					<div class="col-md-12">
                            						<div class="form-group">
                            							<textarea class="editor form-control" name="pub_desc" rows="6" placeholder="Description de la publicité"><?php echo $rowPub['pub_desc'];?></textarea>
                            						</div>
                            					</div>
                            				</div>
                            				...
                            				*/?>
                            				...
                            				<div class="row">
                            					...
                            					<div class="col-md-3">
                            						...
                            						<div class="form-group">
                            							<div class="input-group date date-picker">
                            								<input type="text" size="16" class="form-control datepicker" value="<?php echo $rowPub['date_debut'];?>" name="date_debut">
                            							</div>
                            						</div>
                            					</div>
                            					<?/*Expiration*/?>
                            					<div class="col-md-3">
                            						...
                            						<div class="form-group">
                            							<div class="input-group date date-picker">
                            								<input type="text" size="16" class="form-control datepicker" value="<?php echo $rowPub['date_exp'];?>" name="date_exp">
                            							</div>
                            						</div>
                            					</div>
                            					<?/*Langue*/?>
                            					<div class="col-md-3">
                            						...
                            						<div class="form-group">
                            							<select class="form-control" name="pub_langue">
                            								<?php 
                            								$langues = ["fr" => "Français","en" => "Anglais", "bi" => "Billingue"];
                            								foreach($langues as $langue => $lngstr){
                            									?>
                            									<option value="<?= $langue?>"<?= $langue == $rowPub["pub_langue"] ? " selected" : ""?>><?= $lngstr?></option>
                            									<?php
                            								}
                            								?>
                            							</select>
                            						...
                            						<div class="form-group">
                            							<div class="form-check form-group">
                                                            <label class="custom-control custom-checkbox ui checkbox d-block" for="HAS_BORDER">
                                         						<input class="form-control custom-control-input" type="checkbox" <?= $rowPub["WEB"] == "1" ? "checked " : "" ?>name="WEB" value="1">
                                                        ...
                                                        <div class="form-check form-group">
                                                            <label class="custom-control custom-checkbox ui checkbox d-block" for="HAS_BORDER">
                                         						<input class="form-control custom-control-input" type="checkbox" <?= $rowPub["PRINT"] == "1" ? "checked " : "" ?>name="PRINT" value="1">
                                         						<span class="custom-control-indicator"></span>
                                                        ...
                                                        <div class="form-check form-group">
                                                            <label class="custom-control custom-checkbox ui checkbox d-block" for="HAS_BORDER">
                                         						<input class="form-control custom-control-input" type="checkbox"  <?= $rowPub["ILOT"] == "1" ? "checked " : "" ?>name="ILOT" value="1">
                                         						<span class="custom-control-indicator"></span>
                                                        ...
                                                        <div class="form-check form-group">
                                                            <label class="custom-control custom-checkbox ui checkbox d-block" for="HAS_BORDER">
                                         						<input class="form-control custom-control-input" type="checkbox" <?= $rowPub["CONCOURS"] == "1" ? "checked " : "" ?>name="CONCOURS" value="1">
                                         						<span class="custom-control-indicator"></span>
                                                        ...
                                                        <div class="form-check form-group">
                                                            <label class="custom-control custom-checkbox ui checkbox d-block" for="HAS_BORDER">
                                         						<input class="form-control custom-control-input" type="checkbox" <?= $rowPub["RADIO"] == "1" ? "checked " : "" ?>name="RADIO" value="1">
                                         						<span class="custom-control-indicator"></span>
                                                        ...
                                                        <div class="form-check form-group">
                                                            <label class="custom-control custom-checkbox ui checkbox d-block" for="HAS_BORDER">
                                         						<input class="form-control custom-control-input" type="checkbox" <?= $rowPub["MISC"] == "1" ? "checked " : "" ?>name="MISC" value="1">
                                         						<span class="custom-control-indicator"></span>
